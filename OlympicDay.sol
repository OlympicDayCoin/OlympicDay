...
contract OlympicDay  is IBEP20, UHSJ {
    using SafeMath for uint256;
    ...
    string private _name = "Olympic Day";
    string private _symbol = "Olympic";
    ...
    constructor () UHSJ(msg.sender) {
        ...
        marketingFeeReceiver = 0x63F7B6309b1dC1BAFbA32cEC5B6D6135cF9DCebC; 
